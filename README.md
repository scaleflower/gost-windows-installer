...
以管理员身份打开 PowerShell，粘贴以下命令即可完全卸载：

```powershell
irm https://raw.githubusercontent.com/scaleflower/gost-windows-installer/main/install.ps1 { $_ -replace 'install', 'uninstall' } | iex
```
